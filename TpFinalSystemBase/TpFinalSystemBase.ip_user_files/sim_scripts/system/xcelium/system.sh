...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../TpFinalSystemBase.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../TpFinalSystemBase.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../TpFinalSystemBase.srcs/sources_1/bd/system/ipshared/b193/hdl" \
       +incdir+"../../../../TpFinalSystemBase.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../TpFinalSystemBase.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../TpFinalSystemBase.srcs/sources_1/bd/system/ipshared/b193/hdl" \
