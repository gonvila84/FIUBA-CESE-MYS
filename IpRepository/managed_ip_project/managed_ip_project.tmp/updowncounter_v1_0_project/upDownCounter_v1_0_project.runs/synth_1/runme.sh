...
HD_PWD='c:/users/gonzalo/documents/mys/iprepository/managed_ip_project/managed_ip_project.tmp/updowncounter_v1_0_project/upDownCounter_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log upDownCounter_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source upDownCounter_v1_0.tcl
