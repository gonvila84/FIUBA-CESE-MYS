...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../TpFinalSystem.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../TpFinalSystem.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../TpFinalSystem.srcs/sources_1/bd/system/ipshared/b193/hdl" \
       +incdir+"../../../../TpFinalSystem.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../TpFinalSystem.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../TpFinalSystem.srcs/sources_1/bd/system/ipshared/b193/hdl" \
