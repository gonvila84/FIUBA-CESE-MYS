...
HD_PWD='C:/Users/Gonzalo/Documents/Mys/TpFinalSystem/TpFinalSystem.runs/system_upDownCounter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_upDownCounter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_upDownCounter_0_0.tcl
